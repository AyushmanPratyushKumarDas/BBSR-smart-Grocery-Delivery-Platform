...
// @access  Private
router.get('/me', require('../middleware/auth.middleware').authenticateToken, asyncHandler(async (req, res) => {
  res.json({
    success: true,
    data: {
...
// @access  Private
router.post('/logout', require('../middleware/auth.middleware').authenticateToken, (req, res) => {
  res.json({
    success: true,
